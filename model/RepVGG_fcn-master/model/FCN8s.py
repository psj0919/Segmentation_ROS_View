...
class FCN8s(nn.Module):
    ...
    def forward(self, x):
        # Conv Block
        conv1 = self.conv_block1(x)     #(1, 64, 227, 227)
        conv2 = self.conv_block2(conv1) #(1, 128, 113, 113)
        conv3 = self.conv_block3(conv2) #(1, 256, 56, 56)
        conv4 = self.conv_block4(conv3) #(1, 512, 28, 28)
        conv5 = self.conv_block5(conv4) #(1, 512, 14, 14)
        conv6 = self.classifier(conv5)  #(1, 21, 8, 8)
