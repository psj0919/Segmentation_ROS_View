...
class demo:
    def __init__(self, backbone, resize_size, org_size_w, org_size_h, device, weight_path, num_class, bounding_box):
    ...
    def run(self, data):
        ...
        with torch.cuda.amp.autocast():
            output_x, output_low_level = self.model(img)

            
            return output_x, output_low_level     
