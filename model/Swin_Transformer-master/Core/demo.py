...
class demo:
    def __init__(self, resize_size, org_size_w, org_size_h, device, weight_path, num_class, model):
    ...
    def load_network(self):
        if self.model_name == "Swin-T":
            model = SwinTransformer(dim=(96, 192, 384, 768), depths = (2, 2, 6, 2), num_heads=(3, 6, 12, 24), resolutions=(56,28,14,7), num_classes=21)
        elif self.model_name == "Swin-S":
            model = SwinTransformer(dim=(96, 192, 384, 768), depths = (2, 2, 18, 2), num_heads=(3, 6, 12, 24), resolutions=(56,28,14,7), num_classes=21)
        elif self.model_name == "Swin-B":
            model = SwinTransformer(dim=(128, 256, 512, 1024), depths = (2, 2, 18, 2), num_heads=(4, 8, 16, 32), resolutions=(56,28,14,7), num_classes=21)
        elif self.model_name == "Swin-L":                        
            model = SwinTransformer(dim=(192, 384, 768, 1536), depths = (2, 2, 18, 2), num_heads=(6, 12, 24, 48), resolutions=(56,28,14,7), num_classes=21)
