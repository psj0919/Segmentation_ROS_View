...
class RepVGG(nn.Module):
    def __init__(self, num_blocks, num_classes = 1000, width_multiplier=None, override_groups_map=None, deploy=False, use_se=False):
        ...
        self.stage4_1 = nn.Conv2d(192, 21, 1) #conv4.shape = [1, 1280, 8, 8]

        self.upscale6 = nn.ConvTranspose2d(21, 21, 4, 2)
        self.upscale = nn.ConvTranspose2d(21, 21, 36, 18)
    ...
    def forward(self, x):
        ...
        output = self.upscale(score)
        output = output[:, :, 5:5+x.size()[2], 5:5+x.size()[3]]
